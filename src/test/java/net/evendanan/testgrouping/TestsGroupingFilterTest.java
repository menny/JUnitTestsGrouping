...
public class TestsGroupingFilterTest {
    ...
    @Test
    public void addTestsGroupingFilterWithSystemPropertiesDataDoesNotThrowExceptionIfNoDataAndFalsePassed() throws Exception {
        Filterable runner = Mockito.mock(Filterable.class);
    ...
    public void addTestsGroupingFilterToRunnerSwallowsNoTestsRemainException() throws Exception {
        ...
        }).when(runner).filter(Mockito.any(Filter.class));
    ...
    @Test(expected = IllegalArgumentException.class)
    public void addTestsGroupingFilterToRunnerDoesNotSwallowsNonNoTestsRemainException() throws Exception {
        Filterable runner = Mockito.mock(Filterable.class);
        Mockito.doAnswer(new Answer() {
            @Override
            public Object answer(InvocationOnMock invocation) throws Throwable {
    ...
    private static int[] generateCountsForGroupCount(final int groupCount, final int testIterationLow, final int testIterationHigh) {
        ...
        for (int testIteration = testIterationLow; testIteration < testIterationHigh; testIteration++) {
            Description description = TestableTestsGroupingFilter.mockDescriptionWithHashcode(testIteration);
