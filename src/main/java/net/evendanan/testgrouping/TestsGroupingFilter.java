...
public class TestsGroupingFilter extends Filter {
    ...
    public static void addTestsGroupingFilterWithSystemPropertiesData(Filterable testRunner, boolean failIfDataMissing) {
        addTestsGroupingFilterWithSystemPropertiesData(testRunner, new TestClassHashingStrategy(), failIfDataMissing);
    }

    public static void addTestsGroupingFilterWithSystemPropertiesData(Filterable testRunner, HashingStrategy hashingStrategy, boolean failIfDataMissing) {
    ...
    public static void addTestsGroupingFilterToRunner(Filterable testRunner, int groupCount, int groupToExecute) {
        addTestsGroupingFilterToRunner(testRunner, new TestClassHashingStrategy(), groupCount, groupToExecute);
    }

    public static void addTestsGroupingFilterToRunner(Filterable testRunner, HashingStrategy hashingStrategy, int groupCount, int groupToExecute) {
        try {
    ...
    private int getGroupNumberFor(Description description, int groupCount) {
        return Math.abs(mHashingStrategy.calculateHashFromDescription(description)) % groupCount;
    }
